...
if [ $# -eq 0 ]; then
    ...
    echo ""
    echo "CSVファイル凡例"
    echo "https://dev-lms.oku.example.org/badges/badge_json.php?id=19,101"
    echo "https://dev-lms.oku.example.org/badges/badge_json.php?id=20,101"
    echo "https://dev-lms.oku.example.org/badges/badge_json.php?id=21,101"
    echo ""
    echo "ビルド時の使用例："
