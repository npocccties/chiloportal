...
class FrameworkFieldListTests(BaseAPIViewTests):
    def test_framework_field_list_200(self):
        ...
        response = self.request_normal(factory, view, self.framework_field_list_url, {'framework_id': self.frm1.id})
    ...
    def test_framework_field_list_400_invalid_value(self):
        factory = APIRequestFactory()
        view = FrameworkFieldList.as_view()
        self.request_invalid_value(factory, view, self.framework_field_list_url, {'framework_id': self.invalid_param_alpha})
        self.request_invalid_value(factory, view, self.framework_field_list_url, {'framework_id': self.invalid_param_fullchar})
    ...
    def test_framework_field_list_404(self):
        ...
        view = FrameworkFieldList.as_view()
        self.create_test_relation_data()
        self.request_not_found(factory, view, self.framework_field_list_url, {'framework_id': self.not_found_id}, 'Field')
