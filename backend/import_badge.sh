...
if [ $# != 1 ]; then
    ...
    echo ""
    echo "CSVファイル凡例"
    echo "https://dev-lms.oku.cccties.org/badges/badge_json.php?id=19,101"
    echo "https://dev-lms.oku.cccties.org/badges/badge_json.php?id=20,101"
    echo "https://dev-lms.oku.cccties.org/badges/badge_json.php?id=21,101"
    echo ""
    echo "本スクリプトの使用例："
