    ...
    <Transition appear show={open} as={Fragment}>
      <Dialog as="div" className="relative z-20" onClose={onClose}>
        <Transition.Child
          ...
          enterTo="bg-[rgba(0,0,0,0.3)]"
          leave="ease-out duration-300"
          leaveFrom="bg-[rgba(0,0,0,0.3)]"
        ...
        >
          <div className="fixed inset-0 overflow-y-auto">
            <Transition.Child
              ...
              leaveTo="translate-x-3/4 opacity-0"
            >
              <Dialog.Panel className="w-full bg-white px-4 pt-6 pb-12 min-h-full relative">
